...
import ProgressSteps from "../../componenets/ProgressSteps.jsx";
    ...
    <div className="mt-[10rem] flex justify-around items-center flex-wrap">
      <form onSubmit={submitHandler} className="w-[40rem]">
        ...
        <div className="mb-4">
          ...
          <input type="text" className="w-full p-2 border rounded" placeholder="Enter postalCode"  value={postalCode} required onChange={e => setPostalCode(e.target.value)}/>
        </div>
        <div className="mb-4">
        ...
        <div className="mb-4">
          <label htmlFor="" className="block text-gray-400">Select Method</label>
          <div className="mt-2">

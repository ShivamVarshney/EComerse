...
function Register() {
 ...
 return (
    // Main container takes full height, uses flex, and centers content
    <section className="h-screen flex items-center pl-[10rem] gap-10 overflow-y-hidden">
      {/* Form container */}
      <div className="flex-shrink-0 max-w-lg w-full p-4"> {/* Added padding and max-w-lg */}
        <h1 className="text-2xl font-semibold mb-4 ">Register</h1>
        <form onSubmit={submitHandler} className="container"> {/* Removed fixed w-[40rem] */}
      ...
      {/* Image container - now truly fills the right side */}
